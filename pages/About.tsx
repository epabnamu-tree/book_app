      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in">
          ...
          <div className="p-8 md:p-12 space-y-8 text-gray-700 leading-loose text-lg font-light">
            <p>
              <strong className="text-primary font-bold">연구그룹 이팝나무</strong>는 기술의 진보가 인간의 삶과 어떻게 조화롭게 공존할 수 있는지를 탐구하는 작은 연구 공동체입니다. 이곳에서 여러 연구자와 함께 사회적경제와 기술의 접점을 꾸준히 고민해 왔습니다.
            </p>
            
            <p>
              여러 해 동안 대학에서 학생들과 함께 사회적경제를 공부하며 '삶의 지속가능성'과 '연대의 구조'를 질문해 왔고, 한편으로는 현장에서 인공지능, 센서, 영상 분석, 장비 개발, 현장 실증 업무에 참여해 왔습니다. 
            </p>

            <div className="border-l-4 border-secondary pl-6 py-2 my-8 italic text-gray-600 bg-gray-50 rounded-r-lg">
              "사회과학의 질문과 기술 현장의 경험이 교차하는 이 길 위에서, <br className="hidden md:block" />
            ...
            <p>
              <span className="font-bold text-primary">"이 거대한 변화의 과실은 누구의 몫이어야 하는가?"</span><br/>
